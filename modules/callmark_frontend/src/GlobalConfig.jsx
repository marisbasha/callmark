        ...
        <Draggable cancel='#global-config-window-non-drag-content'>
            <div id='global-config-window'>
                ...
                <Box id="global-config-window-non-drag-content" display={"flex"} flexDirection={"column"} width="100vw" >
                    ...
                    <Box style={{"paddingLeft":"10px", "paddingBottom":"10px", height:"40px"}} display={"flex"} alignItems={"center"}>{showAllAnnotationCanvases?"Hide All Annotations":"Show All Annotations"}
                        <Box style={{"paddingLeft": showAllAnnotationCanvases? "120px":"113px"}}> 
                            <Tooltip title={showAllAnnotationCanvases?"Hide":"Show"}> 
                                <IconButton
                                    style={{
                                        position: 'relative',
                                        paddingBottom: "15px"
                                    }}
                                    onClick={ ()=>{ setShowAllAnnotationCanvases( !showAllAnnotationCanvases ) } }
                                    >
                                    {/* First Icon */}
                                    <LineStyleIcon
                                        style={{
