...
const ANNOTATED_AREA_INDIVIDUAL_TRAIN_WHISPERSEG = '🎯Train WhisperSeg'
const ANNOTATED_AREA_INDIVIDUAL_FULLY_ANNOTATED = '🎯Annotated Area'

const ANNOTATED_AREA_CLUSTERNAME = '✅Select'
