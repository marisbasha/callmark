...
**Fully customizable:** Choose among linear, log-mel or constant-q spectrogram display options. Customize N-FFT and Bits Per Octave values for tailored spectrogram displays.
...
(recommended for reducing the occurrence of chrome automatic discarding)
